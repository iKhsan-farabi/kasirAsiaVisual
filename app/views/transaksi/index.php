<div class="container-mt-5 overflow-auto">
    ...
    <div class="form-group mb-3 ml-3">
        <div class="input-group w-50">
            ...
            <input type="text" class="form-control" placeholder="Tanggal Order ... "disabled readonly>
            <a class="btn btn-secondary"><i class="fa fa-clock mr-2"></i>Jam Order</a>
            <input type="text" class="form-control" placeholder="Jam Order " disabled readonly>
        </div>
    </div>
    <div class="form-group mb-3 ml-3">
        <div class="input-group date w-50">
            <a class="btn btn-secondary"><i class="fa fa-calendar-week mr-2"></i>Tgl Ambil</a>
            <input type="text" class="form-control" placeholder="Tanggal Ambil ... " disabled readonly>
            <a class="btn btn-secondary"><i class="fa fa-clock mr-2"></i>Jam Ambil</a>
            <input type="text" class="form-control" placeholder="Jam Ambil " disabled readonly>
        </div>
    </div>
    <p class="ml-3">
        ...
        ?>
        <button class="btn btn-success" id="#"><i class="fa fa-mail-bulk mr-2"></i>Buat Invoices Baru</button>
        <a class="btn btn-secondary" href="<?= reload ?>" id="#"><i class="fas fa-sync-alt mr-2"></i>Reload</a>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        ?>
                                                ...
                                                <td><a href="<?= BASE_URL ?>/transaksi/detail/<?= $customer['idcustomer']; ?>" class="btn btn-primary"><i class="fas fa-clipboard-list mr-2"></i>Pilih</a></td>
                                    </tr>
                            <?php }
                                        }
                            ?>
                ...
                <div class="modal-body">
                    <table>
                        <tr>
                            <td>
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Jenis Cetakan">
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group mb-3 ml-4">
                                    <a class="btn btn-secondary"><i class="fas fa-tag"></i></a>
    ...
    <div class="modal fade" id="inputDocu" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Form Input Pemesanan Digital Print</h5>
